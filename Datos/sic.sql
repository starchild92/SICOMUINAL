...
REPLACE INTO `admin_aguas_blancas` (`id`, `nombre`) VALUES
(1, 'Acuaeducto'),
(2, 'Camión'),
(4, 'Del Río'),
(3, 'Pila Pública');
...
REPLACE INTO `admin_aguas_servidas` (`id`, `nombre`) VALUES
(2, 'Cloaca'),
(1, 'Pozo séptico');
...
REPLACE INTO `admin_area_trabajo_c_c` (`id`, `nombre`) VALUES
...
REPLACE INTO `admin_clas_ingreso_familiar` (`id`, `nombre`) VALUES
(2, 'Diario'),
(1, 'Mensual'),
...
REPLACE INTO `admin_estado_civil` (`id`, `nombre`) VALUES
(2, 'Casado(a)'),
(4, 'Concubino(a)'),
(3, 'Divorciado(a)'),
(1, 'Soltero(a)'),
...
REPLACE INTO `admin_incapacidades` (`id`, `incapacidad`) VALUES
...
REPLACE INTO `admin_mecanismo_informacion` (`id`, `nombre`) VALUES
(4, 'Internet'),
...
REPLACE INTO `admin_misiones_comunidad` (`id`, `nombre`) VALUES
(6, 'Barrio Adentro'),
(7, 'Ezequiel Zamora'),
(5, 'Identidad'),
(8, 'Luis Pérez'),
...
REPLACE INTO `admin_nacionalidad` (`id`, `nacionalidad`) VALUES
(4, 'Extragero/a'),
(3, 'Naturalizado'),
(1, 'Venezolano/a');
...
REPLACE INTO `admin_nivel_instruccion` (`id`, `nombre`) VALUES
(3, 'Bachiller'),
(2, 'Básica'),
(7, 'Postgrado'),
(1, 'Sin Instrucción'),
...
REPLACE INTO `admin_org_comunitaria` (`id`, `nombre`) VALUES
(1, 'Organización 1'),
(2, 'Organización 2'),
(3, 'Organización 3'),
(4, 'PeTA');
...
REPLACE INTO `admin_pensionado_institucion` (`id`, `nombre`) VALUES
(1, 'IVICC'),
(2, 'IVSS');
...
REPLACE INTO `admin_preguntas` (`id`, `pregunta`) VALUES
...
REPLACE INTO `admin_preguntas_participacion_comunitaria` (`id`, `respCerrada`, `pregunta`) VALUES
(4, 2, 1);
...
REPLACE INTO `admin_profesion` (`id`, `nombre`) VALUES
(2, 'Albañil'),
...
REPLACE INTO `admin_recoleccion_basura` (`id`, `nombre`) VALUES
(5, 'Al Aire Libre'),
(1, 'Aseo Urbano'),
(3, 'Bajante'),
(4, 'Camión'),
...
REPLACE INTO `admin_resp_cerrada` (`id`, `respuesta`) VALUES
(2, 'No'),
(1, 'Si');
...
REPLACE INTO `admin_salubridad_vivienda` (`id`, `nombre`) VALUES
(1, 'Limpia');
...
REPLACE INTO `admin_servicios_comunales` (`id`, `nombre`) VALUES
(2, 'Abastos'),
(3, 'Bodega'),
(10, 'Cancha'),
(11, 'Casa Comunal'),
...
REPLACE INTO `admin_sistema_electrico` (`id`, `nombre`) VALUES
...
REPLACE INTO `admin_tipo_ayuda_especial` (`id`, `nombre`) VALUES
...
REPLACE INTO `admin_tipo_enseres` (`id`, `nombre`) VALUES
(1, 'Nevera');
...
REPLACE INTO `admin_tipo_gas` (`id`, `nombre`) VALUES
(1, 'Bombonas'),
(3, 'No posee'),
(2, 'Tubería');
...
REPLACE INTO `admin_tipo_habitaciones_vivienda` (`id`, `nombre`) VALUES
(1, 'Sala');
...
REPLACE INTO `admin_tipo_ingresos` (`id`, `nombre`) VALUES
(5, '2001 o más'),
(3, '201 a 600'),
(4, '601 a 2000'),
(2, 'Menos de 200'),
...
REPLACE INTO `admin_tipo_mascotas` (`id`, `nombre`) VALUES
(2, 'Gato'),
(1, 'Perro');
...
REPLACE INTO `admin_tipo_padecencia` (`id`, `nombre`) VALUES
(2, 'Diabetes'),
(1, 'SIDA');
...
REPLACE INTO `admin_tipo_paredes` (`id`, `nombre`) VALUES
(1, 'Frisadas'),
(2, 'Sin Frizar'),
(3, 'Tablas');
...
REPLACE INTO `admin_tipo_plagas` (`id`, `nombre`) VALUES
(1, 'Moscas'),
(2, 'Ratones');
...
REPLACE INTO `admin_tipo_situacion_exclusion` (`id`, `situacion`, `cantidad`) VALUES
...
REPLACE INTO `admin_tipo_techo` (`id`, `nombre`) VALUES
(1, 'Platabanda');
...
REPLACE INTO `admin_tipo_telefonia` (`id`, `nombre`) VALUES
(1, 'Celular'),
(2, 'Domiciliaría');
...
REPLACE INTO `admin_tipo_tenencia` (`id`, `forma`) VALUES
(1, 'Propia');
...
REPLACE INTO `admin_tipo_transporte` (`id`, `nombre`) VALUES
(3, 'Bestias'),
(4, 'Privado (Taxi)'),
(1, 'Propio'),
(2, 'Público');
...
REPLACE INTO `admin_tipo_vivienda` (`id`, `nombre`) VALUES
(1, 'Quinta');
...
REPLACE INTO `admin_ubicacion_trabajo` (`id`, `nombre`) VALUES
...
REPLACE INTO `admin_venta_vivienda` (`id`, `nombre`) VALUES
(1, 'Dulces'),
(2, 'Helados');
...
REPLACE INTO `comunidad` (`id`, `estado`, `municipio`, `parroquia`, `sector`, `comunidad`, `direccion`) VALUES
...
REPLACE INTO `consejo_comunal` (`id`, `nombre`, `codigo`, `rif`, `numeroCuenta`) VALUES
...
REPLACE INTO `telefono` (`id`, `codigo`, `numero`) VALUES
(1, '0241', '8479997'),
(2, '0414', '8479997'),
(3, '0414', '4415939'),
(4, '0414', '8479997');
...
REPLACE INTO `usuario` (`id`, `username`, `username_canonical`, `email`, `email_canonical`, `enabled`, `salt`, `password`, `last_login`, `locked`, `expired`, `expires_at`, `confirmation_token`, `password_requested_at`, `roles`, `credentials_expired`, `credentials_expire_at`, `primerNombre`, `segundoNombre`, `primerApellido`, `segundoApellido`, `cedula`, `fechaNacimiento`) VALUES
...
REPLACE INTO `usuario_telefonos` (`usuario_id`, `telefono_id`) VALUES
(1, 1),
(2, 2),
(1, 3);
